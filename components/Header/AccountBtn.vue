...
<template>
  ...
  <!-- .... small devices ..... -->
  <div
    class="flex md:hidden cursor-pointer hoverLink p-1.5 h-full items-center whitespace-nowrap ml-2"
    @click="showAccountMenu = !showAccountMenu"
  >
    <div class="hidden sm:block text-xl opacity-90 font-normal mr-2 ">
      <span v-if="isLoggedIn" class="text-sm truncate max-w-[120px] block">{{ userName }}</span>
